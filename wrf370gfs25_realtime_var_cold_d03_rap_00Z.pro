...
>>>>>>> 2017-05-20_Control
   ...
   PRINTF, 1, STRING(START_YEAR, START_MONTH, START_DAY, START_HOUR, $
                     FORMAT='(I4.4,"-",I2.2,"-",I2.2,"_",I2.2)')
   CLOSE, 1
...
;if (three_daytest eq 0) then begin
   ...
   WRF_OUTSTORE = WRF_OUTSTORE + $
                  STRING(START_YEAR, START_MONTH, START_DAY, START_HOUR, $
                         FORMAT='("/",I4.4,"-",I2.2,"-",I2.2,"_",I2.2,"/")')
...
>>>>>>> Stashed changes
=======
      SPAWN, "export NCL_ROOT=/usr/  && "                      + $
             "ncl " + wrf_home_dir + "ts2nc_autoread_d01.ncl"
>>>>>>> 2017-05-20_Control
...
=======
      SPAWN, "export NCL_ROOT=/usr/  && "                      + $
             "ncl " + wrf_home_dir + "ts2nc_autoread_d02.ncl"
